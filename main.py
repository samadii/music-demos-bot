                ...
                if not str(chat_id) in blacklist:
                    ...
                    if update.effective_message.text:
                        if "start" in update.effective_message['text']:
                            ...
                            try:
                                bot.send_message(chat_id, "Hey !  I am a simple Audio Cutter Bot !  I can send you a short piece of musics, The cut piece will be in the form of an voice message.", reply_to_message_id = update.effective_message.message_id, reply_markup = InlineKeyboardMarkup([InlineKeyboardButton("📬 Share", url='https://github.com/nertflix/button-creator-bot')])) 
                            except:
                                pass
